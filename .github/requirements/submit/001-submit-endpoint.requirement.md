...
of RPP messages (Section 4.1, Section 4.3, Section 7.1). The recommended path
is `POST /rpp/v1/messages`.
...
- The request body is JSON and contains the base message envelope fields
  defined by Section 7.1.
