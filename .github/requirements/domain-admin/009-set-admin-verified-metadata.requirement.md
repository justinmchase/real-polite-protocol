...
- The tool accepts a target user `oid` and a map of arbitrary string field names
  to string values. Each value MUST be a string no longer than 512 characters.
  The admin supplies the values directly — the token is not consulted.
